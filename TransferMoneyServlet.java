...
//	pw.println("<b>transfermoneypage</b>");
		try {
			...
			pw.println("<body>" + "<div id='logo_div'>" + "<img id='image' src='Picsart_24-10-02_22-19-03-595.png' />"
					...
					+ "<fieldset id='field'>" + "<table cellpadding='0' cellspacing='20'>"
					+ "<tr><td class='cat'>To Acc.no</td><td>:<input type='tel' maxlength='16' minlength='16' name='accountno' required /></td></tr>"
					+ "<tr><td class='cat'>Amount</td><td>:<input type='tel' step='100' name='amount' required /></td></tr>"
					+ "<tr><td class='cat'>Enter PIN</td><td>:<input type='password' name='password' required /></td></tr>"
					+ "</table>" + "<input type='submit' id='form_sub' value='Transfer'>" + "</fieldset>" + "</form>"
					+ "</body>");
		}catch (Exception e) {
